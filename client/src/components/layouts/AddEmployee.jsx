...
class AddEmployee extends Component {
  constructor() {
    ...
    this.state = {
      ...
      // teams and roels
      teamList: ['Team Salman', 'Team Rahul', 'Team Albar'],
      roleList: ['Frontend-engineer', 'backend-engineer', 'Full-Stack-engineer', 'DevOps', 'Data Analyst', 'UI/UX Design', 'Product Manager'],
    };
  }
